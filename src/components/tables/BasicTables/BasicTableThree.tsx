...
const carBrandStyles: Record<string, { bg: string; text: string; initial: string }> = {
  ...
  "Skoda": { bg: "bg-green-600", text: "text-white", initial: "Š" },
  "Mazda": { bg: "bg-red-700", text: "text-white", initial: "M" },
  "Nissan": { bg: "bg-red-500", text: "text-white", initial: "N" },
  "Ford": { bg: "bg-blue-800", text: "text-white", initial: "F" },
  "Porsche": { bg: "bg-red-600", text: "text-white", initial: "P" },
  "Land Rover": { bg: "bg-green-700", text: "text-white", initial: "LR" },
};

// Mechanic data with planet avatars
const mechanicPlanets: Record<string, string> = {
  "Иванов А.": "/images/planets/mars.svg",
  "Петров С.": "/images/planets/saturn.svg",
  "Сидоров Д.": "/images/planets/jupiter.svg",
  "Козлов М.": "/images/planets/neptune.svg",
  "Николаев В.": "/images/planets/venus.svg",
};

// Type definition for the service history data
interface ServiceHistory {
  ...
  price: string;
  mechanic: string;
  status: "Выполнен" | "В работе" | "Отменён";
}
...
function CarBrandIcon({ brand }: { brand: string }) {
  const style = carBrandStyles[brand] || { bg: "bg-gray-500", text: "text-white", initial: brand[0] };
...
export default function BasicTableThree() {
  ...
  const currentItems = serviceHistoryData.slice(indexOfFirstItem, indexOfLastItem);

  // Calculate total pages
  const totalPages = Math.ceil(serviceHistoryData.length / itemsPerPage);
                ...
                <TableRow key={index}>
                  <TableCell className="px-4 py-4">
                    <div className="flex items-center gap-3">
                      <CarBrandIcon brand={item.brandKey} />
                      <div>
                  ...
                  <TableCell className="px-4 py-4 text-success-600 dark:text-success-400 text-theme-sm font-semibold">
                    {item.price}
                  </TableCell>
                  <TableCell className="px-4 py-4">
                    <div className="flex items-center gap-2">
                      <img 
                        src={mechanicPlanets[item.mechanic]} 
                        alt="" 
