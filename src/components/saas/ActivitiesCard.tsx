      ...
      <div className="relative">
        ...
        <div className="relative mb-6 flex">
          <div className="z-10 flex-shrink-0">
            <div className="size-10 rounded-full bg-gray-100 dark:bg-gray-800 p-1.5 ring-4 ring-white dark:ring-gray-800">
              <img
