...
export default function TaskHeader() {
  ...
  const taskGroups = [
    { name: "Все заказы", key: "All", count: 14 },
    { name: "Новые", key: "Todo", count: 3 },
    { name: "В работе", key: "InProgress", count: 4 },
    { name: "Готовы", key: "Completed", count: 4 },
  ];
      ...
      >
        <div className="px-2">
          ...
          <p className="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
            Создайте новый заказ-наряд для автомобиля
          </p>
        </div>
          ...
          <div className="flex flex-col items-center gap-6 px-2 mt-6 sm:flex-row sm:justify-between">
            <div className="flex flex-col items-center gap-3 sm:flex-row">
              ...
              <div className="flex -space-x-2">
                <div className="w-8 h-8 overflow-hidden border border-white rounded-full dark:border-gray-900 bg-gray-100 dark:bg-gray-800 p-1">
                  <img src="/images/planets/earth.svg" alt="user" className="w-full h-full" />
                </div>
                <div className="w-8 h-8 overflow-hidden border border-white rounded-full dark:border-gray-900 bg-gray-100 dark:bg-gray-800 p-1">
                  <img src="/images/planets/mars.svg" alt="user" className="w-full h-full" />
                </div>
                <div className="w-8 h-8 overflow-hidden border border-white rounded-full dark:border-gray-900 bg-gray-100 dark:bg-gray-800 p-1">
                  <img src="/images/planets/jupiter.svg" alt="user" className="w-full h-full" />
                </div>
              </div>
            </div>
