    ...
    <div className="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
      ...
      <div className="p-5 border-t border-gray-100 dark:border-gray-800 sm:p-6">
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 sm:gap-6">
          <FolderCard title="Основной склад" fileCount="4 892" size="8 540 000 ₽" />
          <FolderCard title="Склад BMW/Audi/MB" fileCount="1 245" size="3 120 000 ₽" />
          <FolderCard title="Склад расходников" fileCount="2 670" size="1 450 000 ₽" />
          <FolderCard title="Резерв/Заказы" fileCount="387" size="2 890 000 ₽" />
        </div>
      </div>
    </div>
  );
